...
node.add(new NarrationSequence("You awaken in the small, poor town of Gregoria, on the outer edge of the forest. The town is filled with dilapidatedbuildings and broken people. You know what to do next. \n" + "Where would you liketo go?"));
}
//Zev Gaslin
@BuilderMethod
...
node.add(new NarrationSequence("You enter a small general store tha seems to be falling apart at the seams and smells of mold and must. You approach the manic store owner. Would you like to purchase anything?"));
node.add(new FadeIn());
...
node.add(new NarrationSequence("Pirate: 'I don't believe ye landlubber! Face me in combat to prove your pirate prowess!'"));
